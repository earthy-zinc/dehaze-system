...
(
    ...
    `scene`       varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci   NOT NULL DEFAULT '' COMMENT '适用场景(前端筛选/展示,如"客服问答")',
    `instruction` text                                                           NULL COMMENT 'SKILL.md指令正文(skill_load时注入,frontmatter之外的内容)',
    `license`     varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci   NULL DEFAULT NULL COMMENT 'SKILL.md frontmatter license(许可证)',
    `compatibility` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'SKILL.md frontmatter compatibility(环境要求)',
    `metadata`    json                                                            NULL COMMENT 'SKILL.md frontmatter metadata(任意键值,如版本/作者)',
    `allowed_tools` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'SKILL.md frontmatter allowed-tools(预批准工具列表,空格分隔)',
