...
(
    ...
    UNIQUE INDEX `uk_recharge_no` (`recharge_no`, `deleted`) USING BTREE,
    UNIQUE INDEX `uk_channel_payment_no` (`channel_payment_no`, `deleted`) USING BTREE,
