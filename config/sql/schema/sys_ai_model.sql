...
-- fallback_model_id 指定降级模型标识（主模型限流/宕机时自动切换），为空表示无降级。
...
(
    ...
    `provider`             varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci   NOT NULL COMMENT '模型提供商(openai;anthropic;deepseek;zhipu;qwen;other)',
    ...
    `fallback_model_id`    varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci  NULL DEFAULT NULL COMMENT '降级模型标识(主模型限流/宕机时自动切换，关联sys_ai_model.model_id)',
