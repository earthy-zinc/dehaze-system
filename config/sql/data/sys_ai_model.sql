...
--   embedding: bge-m3(内置本地, 1024维) —— 知识库创建时按 sys_ai_model 注册表校验
--              （model_type=embedding 且启用，走 ai:model:list 缓存），不设代码白名单；
--              本地向量服务(8992 /v1/embeddings)接受任意模型名。
--              text-embedding-3-small/large(openai, 1536/3072维) 为历史知识库可选模型，
--              播种保持注册表内可用；
...
INSERT INTO `sys_ai_model` (`id`,`provider_id`,`model_id`,`model_type`,`dimension`,`display_name`,`max_context_tokens`,`max_output_tokens`,`supports_multimodal`,`supports_tool_call`,`supports_streaming`,`supports_prompt_cache`,`supports_structured_output`,`extra_request_params`,`fallback_model_id`,`prompt_cache_prefix_len`,`image_tokens_per_image`,`concurrency_limit`,`status`,`vip_level`,`deleted`,`create_by`,`update_by`,`create_time`,`update_time`)  VALUES ('201','1','text-embedding-3-small','embedding','1536','Text Embedding 3 Small','8192','0','0','0','0','0','0',NULL,NULL,'0','0',NULL,'1','0','0','2','2','2026-08-21 00:00:00','2026-08-21 00:00:00');
INSERT INTO `sys_ai_model` (`id`,`provider_id`,`model_id`,`model_type`,`dimension`,`display_name`,`max_context_tokens`,`max_output_tokens`,`supports_multimodal`,`supports_tool_call`,`supports_streaming`,`supports_prompt_cache`,`supports_structured_output`,`extra_request_params`,`fallback_model_id`,`prompt_cache_prefix_len`,`image_tokens_per_image`,`concurrency_limit`,`status`,`vip_level`,`deleted`,`create_by`,`update_by`,`create_time`,`update_time`)  VALUES ('202','1','text-embedding-3-large','embedding','3072','Text Embedding 3 Large','8192','0','0','0','0','0','0',NULL,NULL,'0','0',NULL,'1','0','0','2','2','2026-08-21 00:00:00','2026-08-21 00:00:00');
