...
class RIDCPOLD(nn.Module):
    def __init__(self,
        ...
        self.quantize_group.append(self.quantizer)
        self.before_quant_group.append(self.before_quant)
        self.after_quant_group.append(self.after_quant)
