...
from benchmark.MADN.enhance0314 import Dehaze, Dehaze1
...
#     meta = torch.load("./dehaze_80.pth", map_location="cuda:1")  # ,map_location="cuda:0"
# else:
#     meta = torch.load("./dehaze_80.pth", map_location=torch.device('cpu'))  # ,map_location="cuda:0"
