package com.pei.dehaze.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, com.pei.dehaze.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
