...
class BaseOptions():
	...
	def initialize(self):
		self.parser.add_argument('--dataroot', default='D:/dzhao/dehazing_360/360hazy_dataset/madan/reside',help='path to images (should have subfolders trainA, trainB, etc)')
