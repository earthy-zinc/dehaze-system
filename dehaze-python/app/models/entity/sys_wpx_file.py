...
from sqlalchemy import CHAR, BigInteger, Index, String
...
class SysWpxFile(BaseModel):
    ...
    origin_path: Mapped[str] = mapped_column(String(255), nullable=False, comment="旧文件路径")
    new_file_id: Mapped[int | None] = mapped_column(BigInteger, nullable=True, comment="新文件id")
    new_path: Mapped[str] = mapped_column(String(255), nullable=False, comment="新文件路径")
