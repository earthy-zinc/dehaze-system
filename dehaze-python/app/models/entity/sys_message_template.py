...
class SysMessageTemplate(BaseModel):
    ...
    name: Mapped[str] = mapped_column(
        String(128), nullable=False, default='', comment='模板名称')
    ...
    channels: Mapped[Optional[Any]] = mapped_column(JSON, nullable=True, comment='默认推送渠道')
    variables: Mapped[Optional[Any]] = mapped_column(JSON, nullable=True, comment='变量定义')
