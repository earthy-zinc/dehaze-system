...
from app.service.ai.memory_es_service import search_memories
...
async def inject_memories(
    ...
    # ③ 检索注入：ES 向量 + 三维权排序（或降级 MySQL LIKE）
    ...
    # 拼装 system 补充块：用户画像 / 工作流提示 / 相关记忆三个区块
    sections = []
