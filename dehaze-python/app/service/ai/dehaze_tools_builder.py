...
工具 schema 从旧 agent_nodes.py 迁移，迁完删除旧文件。
"""
...
from app.service.ai.algorithm_recommend_service import recommend_algorithm
from app.service.ai.async_resume import submit_batch_task
from app.service.ai.batch_process_service import process_batch
from app.service.ai.code_sandbox import code_sandbox
from app.service.ai.interrupt_handler import interrupt_handler
from app.service.ai.knowledge_base_tool import knowledge_base_client
from app.service.ai.mcp_gateway_client import mcp_gateway_client
from app.service.ai.skill_manager import skill_manager
from app.service.ai.web_search_client import (
    check_search_quota,
