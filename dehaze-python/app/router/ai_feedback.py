...
from app.service.ai_feedback_service import AiFeedbackService
...
async def submit_feedback(
    ...
    result = await AiFeedbackService.submit_feedback(db, message_id, user.id, form)
...
async def get_feedback(
    ...
    result = await AiFeedbackService.get_feedback(db, message_id, user.id)
    return success(result)
...
async def revoke_feedback(
    ...
    await AiFeedbackService.revoke_feedback(db, message_id, user.id)
