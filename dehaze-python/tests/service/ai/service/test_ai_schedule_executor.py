...
from app.service.ai.service import ai_schedule_executor as ex
from app.service.ai.service.ai_schedule_executor import ScheduleExecutor
from tests.stubs.fakes import FakeInternalResponse, MinimalExecutorDB
