...
from app.service.ai.paradigm_middleware import ParadigmMiddleware, _PlanExecutor
...
async def test_plan_execute_emits_via_sync_stream_writer(monkeypatch):
    ...
    monkeypatch.setattr("app.service.ai.paradigm_middleware.interrupt_handler", _IH())
    monkeypatch.setattr("app.service.ai.paradigm_middleware.interrupt", lambda data: {})
