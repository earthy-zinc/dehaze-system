from tests.stubs import async_ret
from app.service.ai import dehaze_tools_builder as builder
from app.service.ai.code_sandbox import CodeSandbox
from app.service.ai.knowledge_base_tool import KnowledgeBaseClient
...
def _patch_web_search(monkeypatch, *, quota=True, client=None):
    monkeypatch.setattr(builder, "get_redis_client", async_ret(object()))
    monkeypatch.setattr(builder, "check_search_quota", async_ret(quota))
    monkeypatch.setattr(
