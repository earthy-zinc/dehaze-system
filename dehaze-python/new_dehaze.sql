...
) ENGINE=InnoDB AUTO_INCREMENT=118 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='算法模型表'
...
CREATE TABLE `sys_dataset` (
                               ...
                               `update_by` bigint DEFAULT NULL COMMENT '修改人ID',
                               PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='数据集表'
...
) ENGINE=InnoDB AUTO_INCREMENT=240098 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='数据集与数据项关联表'
...
CREATE TABLE `sys_eval_log` (
                                ...
                                `time` bigint DEFAULT '0' COMMENT '评估时间（秒）',
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='模型预测日志表'
...
CREATE TABLE `sys_file` (
                            ...
                            UNIQUE KEY `md5` (`md5`)
) ENGINE=InnoDB AUTO_INCREMENT=552364 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='文件表'
...
) ENGINE=InnoDB AUTO_INCREMENT=276178 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='数据项图片关联表'
...
CREATE TABLE `sys_menu` (
                            ...
                            PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=108 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='菜单管理'
...
CREATE TABLE `sys_pred_log` (
                                ...
                                `pred_md5` char(32) NOT NULL COMMENT '预测图像md5值',
                                `pred_url` text NOT NULL COMMENT '预测图像url',
                                `time` bigint DEFAULT '0' COMMENT '推理时间（秒）',
                                `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
                                `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
                                `create_by` bigint DEFAULT NULL COMMENT '创建人ID',
                                `update_by` bigint DEFAULT NULL COMMENT '修改人ID',
                                ...
                                KEY `idx_pred_md5` (`pred_md5`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='模型预测日志表'
...
CREATE TABLE `sys_wpx_file` (
                                ...
                                `update_time` datetime DEFAULT NULL,
                                PRIMARY KEY (`id`) USING BTREE,
                                UNIQUE KEY `origin_md5` (`origin_file_id`,`origin_md5`),
                                UNIQUE KEY `new_md5` (`new_file_id`,`new_md5`)
) ENGINE=InnoDB AUTO_INCREMENT=501 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='WPX文件表'
