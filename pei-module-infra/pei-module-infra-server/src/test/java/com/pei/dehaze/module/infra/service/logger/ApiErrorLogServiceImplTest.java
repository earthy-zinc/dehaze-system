...
import com.pei.dehaze.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
...
import static com.pei.dehaze.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.pei.dehaze.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        reqVO.setApplicationName("pei-test");
