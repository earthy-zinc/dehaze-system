...
final dioClientProvider = Provider<DioClient>((ref) => DioClientImpl());

final networkInfoProvider = Provider<NetworkInfo>((ref) => NetworkInfoImpl(Connectivity()));

// 数据源Providers
final dehazeLocalDataSourceProvider = Provider<DehazeLocalDataSource>((ref) => DehazeLocalDataSourceImpl(ref.read(sharedPreferencesProvider)));

final dehazeRemoteDataSourceProvider = Provider<DehazeRemoteDataSource>((ref) => DehazeRemoteDataSourceImpl(ref.read(dioClientProvider)));

// 仓库Providers
final dehazeRepositoryProvider = Provider<DehazeRepository>((ref) => DehazeRepositoryImpl(
