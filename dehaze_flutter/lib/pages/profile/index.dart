...
class _ProfilePageState extends ConsumerState<ProfilePage> {
  ...
  static const _adminGroups = [
    ...
    _AdminGroup('算法与数据', [
      _EntryItem(Icons.science_outlined, '算法管理', '/profile/system/algorithm-manage', permission: 'sys:algorithm:*'),
      _EntryItem(Icons.storage_outlined, '数据集管理', '/profile/system/dataset-manage', permission: 'sys:dataset:*'),
    ]),
    _AdminGroup('系统管理', [
      _EntryItem(Icons.people_outline, '用户管理', '/profile/system/user-manage', permission: 'sys:user:*'),
      _EntryItem(Icons.admin_panel_settings_outlined, '角色管理', '/profile/system/role-manage', permission: 'sys:role:*'),
      _EntryItem(Icons.menu_open_outlined, '菜单管理', '/profile/system/menu-manage', permission: 'sys:menu:*'),
      _EntryItem(Icons.business_outlined, '部门管理', '/profile/system/dept-manage', permission: 'sys:dept:*'),
      _EntryItem(Icons.book_outlined, '字典管理', '/profile/system/dict-manage', permission: 'sys:dict:*'),
      _EntryItem(Icons.assignment_outlined, '任务管理', '/profile/system/task-manage', permission: 'sys:task:*'),
    ]),
    _AdminGroup('运营管理', [
      _EntryItem(Icons.card_membership_outlined, '会员管理', '/profile/system/member-manage', permission: 'sys:member:*'),
      _EntryItem(Icons.inventory_2_outlined, '套餐管理', '/profile/system/package-manage', permission: 'sys:package:*'),
      _EntryItem(Icons.receipt_long_outlined, '订单管理', '/profile/system/order-manage', permission: 'sys:order:*'),
      _EntryItem(Icons.rate_review_outlined, '反馈评价管理', '/profile/system/feedback-manage', permission: 'sys:feedback:*'),
      _EntryItem(Icons.recommend_outlined, '推荐管理', '/profile/system/recommend-manage', permission: 'sys:recommendation:*'),
      _EntryItem(Icons.campaign_outlined, '消息管理', '/profile/system/message-manage', permission: 'sys:notify:*'),
    ]),
  ];
}
