...
- [设计系统总览](designEADME.md) - 设计理念和规范概览
- [设计系统规范](design1-design-system.md) - 色彩、字体、间距、圆角系统
...
- [架构设计总览](architectureEADME.md) - 架构设计和文档导航
- [系统总体架构](architecture1-architecture.md) - Clean Architecture + Feature-First模式
- [用户旅程设计](architecture2-user-journey.md) - 5阶段用户交互流程
- [UI组件架构](architecture5-ui-components.md) - 组件分层和状态管理
- [状态管理架构](architecture3-state-management.md) - Riverpod状态管理方案
- [API集成设计](architecture4-api-integration.md) - 后端服务集成和通信
- [跨平台适配策略](architecture6-cross-platform.md) - 6平台适配详细方案
...
- [模块设计总览](moduleEADME.md) - 模块化设计原则和架构规范
- [首页模块设计](module1-home-module.md) - 产品介绍和功能引导
- [图像输入模块](module2-image-input-module.md) - 多种图像输入方式
- [算法选择模块](module3-algorithm-select-module.md) - 智能推荐和参数配置
- [去雾处理模块](module4-dehaze-processing-module.md) - 核心图像处理功能
- [效果对比模块](module5-effect-comparison-module.md) - 多维度效果评估
- [算法管理模块](module6-algorithm-management-module.md) - 算法CRUD和版本控制
- [数据集管理模块](module7-dataset-management-module.md) - 数据集浏览和管理
...
- [测试策略总览](testEADME.md) - 测试体系重构说明和导航
- [性能优化总览](test0-performance-overview.md) - 5层性能优化架构
- [设备性能检测](test1-device-performance.md) - 设备分级和性能评估
- [动画性能优化](test2-animation-performance.md) - 流畅动画和帧率控制
- [内存管理策略](test3-memory-management.md) - 内存监控和泄漏防护
- [渲染优化技术](test4-rendering-optimization.md) - UI渲染和图像处理优化
- [网络优化方案](test5-network-optimization.md) - 请求缓存和离线支持
- [测试策略](test6-testing-strategy.md) - 7:2:1测试金字塔架构
- [代码质量保证](test7-code-quality.md) - 120+项静态分析规则
- [持续集成](test8-continuous-integration.md) - 8阶段CI/CD流水线
...
1. [系统总体架构](architecture1-architecture.md) - 了解整体架构设计
2. [设计系统规范](design1-design-system.md) - 掌握设计标准
3. [模块设计总览](moduleEADME.md) - 理解模块化架构
4. [性能优化总览](test0-performance-overview.md) - 制定性能策略
5. [持续集成](test8-continuous-integration.md) - 建立开发流程

#### 🎨 UI/UX设计师
**推荐阅读路径**：

1. [设计系统总览](designEADME.md) - 理解设计理念
2. [设计系统规范](design1-design-system.md) - 掌握基础规范
...
1. [设计系统规范](design1-design-system.md) - 学习设计标准
2. [通用组件设计](design2-common-components.md) - 掌握基础组件
3. [系统总体架构](architecture1-architecture.md) - 理解架构模式
4. [状态管理架构](architecture3-state-management.md) - 学习状态管理
5. [对应模块文档](module/) - 实现具体功能模块
6. [测试策略](test6-testing-strategy.md) - 编写高质量测试

#### ⚙️ 后端开发者
**推荐阅读路径**：

1. [系统总体架构](architecture1-architecture.md) - 了解前后端分工
2. [API集成设计](architecture4-api-integration.md) - 理解API设计
3. [对应业务模块](module/) - 了解业务逻辑需求
4. [网络优化方案](test5-network-optimization.md) - 优化网络通信
5. [持续集成](test8-continuous-integration.md) - 配置部署流程

#### 🧪 测试工程师
**推荐阅读路径**：

1. [测试策略总览](testEADME.md) - 理解测试体系
2. [测试策略](test6-testing-strategy.md) - 掌握测试方法
3. [代码质量保证](test7-code-quality.md) - 建立质量标准
4. [性能优化总览](test0-performance-overview.md) - 了解性能测试
5. [各模块文档](module/) - 理解业务测试需求

#### 🚀 DevOps工程师
**推荐阅读路径**：

1. [持续集成](test8-continuous-integration.md) - 建立CI/CD流程
2. [设备性能检测](test1-device-performance.md) - 配置性能监控
3. [网络优化方案](test5-network-optimization.md) - 优化部署策略
4. [代码质量保证](test7-code-quality.md) - 集成质量检查
...
1. [设计系统规范](design1-design-system.md) - 了解基础设计规范
2. [系统总体架构](architecture1-architecture.md) - 理解项目架构
3. [首页模块设计](module1-home-module.md) - 从简单模块开始

### 🏗️ 架构设计
**系统架构相关**：

1. [系统总体架构](architecture1-architecture.md)
2. [用户旅程设计](architecture2-user-journey.md) (v2.0重构✅)
3. [API集成设计](architecture4-api-integration.md) (v2.0重构✅)
4. [UI组件架构](architecture5-ui-components.md) (v2.0重构✅)

### 🎨 UI设计实现
**界面开发相关**：

1. [设计系统规范](design1-design-system.md)
2. [通用组件设计](design2-common-components.md)
3. [业务组件设计](design4-business-components.md)
4. [响应式设计](design5-responsive-design.md)

### ⚡ 性能优化
**性能提升相关**：

1. [性能优化总览](test0-performance-overview.md)
2. [设备性能检测](test1-device-performance.md)
3. [动画性能优化](test2-animation-performance.md)
4. [内存管理策略](test3-memory-management.md)

### 🧪 质量保证
**测试和质量相关**：

1. [测试策略总览](testEADME.md)
2. [测试策略](test6-testing-strategy.md)
3. [代码质量保证](test7-code-quality.md)
4. [持续集成](test8-continuous-integration.md)
...
详细设计规范请参考 [设计系统文档](design1-design-system.md)
...
参考 [模块设计总览](moduleEADME.md) 中的模块结构，按照Clean Architecture创建：
...
参考 [性能优化总览](test0-performance-overview.md)：
...
参考 [测试策略](test6-testing-strategy.md)：
...
参考 [代码质量保证](test7-code-quality.md)：
...
- ✅ [用户旅程设计](architecture2-user-journey.md) - 5阶段交互流程，80+设计表格
- ✅ [UI组件架构](architecture5-ui-components.md) - 通用组件详细设计规范
- ✅ [API集成设计](architecture4-api-integration.md) - 完整API集成架构
...
1. **新手入门**：从 [设计系统规范](design1-design-system.md) 开始
2. **架构理解**：阅读 [系统总体架构](architecture1-architecture.md)
3. **模块开发**：参考具体 [模块设计文档](module/)
4. **性能优化**：学习 [性能优化策略](test0-performance-overview.md)
