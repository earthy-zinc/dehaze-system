...
| `A0200`~`A0214` | 认证管理 | 登录认证、验证码相关；`A0211` 密码错误次数超限（临时锁定）、`A0212` 客户端认证失败（预留，当前无端点触发） |
| `A0250`~`A0259` | 推荐管理 | |
| `A0300`~`A030F` | 通用权限异常 | `A0300` 访问权限异常、`A0301` 访问未授权、`A0302` 演示环境限制、`A0304` IP 临时封禁 |
| `A0400`~`A0409` | 通用资源不存在 | `A0401` 资源不存在 |
| `A0500`~`A0509` | 通用业务错误 | |
| `A0510`~`A0519` | 会员管理 | |
| `A0520`~`A052F` | 套餐管理 | 含优惠券扩展 `A052A`~`A052B` |
| `A0530`~`A053F` | 订单管理 | 订单业务错误 |
| `A0540`~`A054F` | 反馈评价 | `A0540`~`A0546` |
| `A0550`~`A055F` | 消息通知 | |
...
| `A0700`~`A0710` | 通用文件上传与导入导出 | 上传格式/大小错误、导入导出校验错误 |
| `B0001`~`B000F` | 通用系统错误 | |
