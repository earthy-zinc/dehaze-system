...
| A0500 | 业务异常 | 商品类型非法、促销价高于原价、计费周期非法、积分卡可得积分必须大于0、套餐名称已被占用、套餐已下架、套餐存在订单无法删除、套餐参与进行中促销无法下架、优惠券已领完、优惠券已禁用、超过限领数量、优惠券不适用该套餐、优惠券状态无效、该套餐仅限新用户购买、续费叠加超过最大有效期（1095 天）、体验券每人限领 1 次 |
