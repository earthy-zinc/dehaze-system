package com.pei.dehaze.module.bpm.controller.admin.definition.vo.group;
...
public class BpmUserGroupRespVO {
    ...
    @Schema(description = "描述", requiredMode = Schema.RequiredMode.REQUIRED, example = "earthyzinc")
