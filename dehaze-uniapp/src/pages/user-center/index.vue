    ...
    <view class="main-content">
      ...
      <view class="section-card">
        ...
        <view class="role-list">
          ...
          <text v-if="auth.roles.length === 0" class="empty-text">暂无角色</text>
        </view>
      </view>
...
const initial = computed(() => (auth.nickname || auth.username || "U").charAt(0).toUpperCase());
...
.profile-card {
  ...
  border-radius: 24rpx; padding: 48rpx 32rpx; margin-bottom: 24rpx;
}
.avatar-wrapper { margin-bottom: 20rpx; }
.avatar-placeholder {
...
.avatar-img { width: 128rpx; height: 128rpx; border-radius: 50%; border: 4rpx solid rgba(255,255,255,0.4); }
.nickname { font-size: 36rpx; font-weight: 700; color: #fff; margin-bottom: 8rpx; }
.username { font-size: 26rpx; color: rgba(255,255,255,0.8); margin-bottom: 8rpx; }
.join-text { font-size: 22rpx; color: rgba(255,255,255,0.6); }
...
.section-title { font-size: 28rpx; font-weight: 600; color: #374151; display: block; }
.section-count { font-size: 24rpx; color: #9ca3af; }

.role-list { display: flex; flex-wrap: wrap; gap: 12rpx; margin-top: 16rpx; }
.role-tag {
  font-size: 24rpx; color: #6366f1; background: #e0e7ff; padding: 8rpx 20rpx; border-radius: 16rpx; font-weight: 500;
}

.perm-grid { display: flex; flex-wrap: wrap; gap: 8rpx; margin-top: 16rpx; }
.perm-item {
  font-size: 22rpx; color: #6b7280; background: #f3f4f6; padding: 6rpx 14rpx; border-radius: 10rpx;
}

.actions { background: #fff; border-radius: 20rpx; overflow: hidden; margin-bottom: 24rpx; box-shadow: 0 2rpx 12rpx rgba(0,0,0,0.04); }
.action-item {
  display: flex; align-items: center; gap: 20rpx; padding: 28rpx;
  &:active { background: #f9fafb; }
  & + & { border-top: 1rpx solid #f3f4f6; }
}
.action-label { flex: 1; font-size: 28rpx; color: #374151; &.danger { color: #ef4444; } }
.empty-text { font-size: 24rpx; color: #9ca3af; margin-top: 12rpx; display: block; }
</style>
