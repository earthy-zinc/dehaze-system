...
```shell
sudo curl -L https://github.com/docker/compose/releases/download/v2.8.1/docker-compose-`uname -s`-`uname -m` -o /usr/local/bin/docker-compose
