...
```shell
scp -r /opt/TC root@192.168.210.100:/opt/TC
scp -r /usr/local/maven root@192.168.210.101:/usr/local

scp -r /usr/local/git root@192.168.210.101:/usr/local && scp -r /usr/local/src/jdk root@192.168.210.101:/usr/local/src && scp -r /opt/docker_volume root@192.168.210.101:/opt
```
