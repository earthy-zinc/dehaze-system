...
func (api *SysRoleApi) GetRolePage(c *gin.Context) {
	...
	// 调用服务获取分页数据
	result, err := api.roleService.GetRolePage(queryParams)
	if err != nil {
...
func (api *SysRoleApi) ListRoleOptions(c *gin.Context) {
	// 调用服务获取角色下拉列表
	options, err := api.roleService.ListRoleOptions()
	if err != nil {
...
func (api *SysRoleApi) AddRole(c *gin.Context) {
	...
	// 调用服务保存角色
	err := api.roleService.SaveRole(roleFormBO)
	if err != nil {
...
func (api *SysRoleApi) GetRoleForm(c *gin.Context) {
	...
	// 调用服务获取角色表单数据
	roleFormBO, err := api.roleService.GetRoleForm(roleId)
	if err != nil {
...
func (api *SysRoleApi) DeleteRoles(c *gin.Context) {
	...
	// 调用服务删除角色
	err := api.roleService.DeleteRoles(ids)
	if err != nil {
...
func (api *SysRoleApi) UpdateRoleStatus(c *gin.Context) {
	...
	// 调用服务更新角色状态
	err = api.roleService.UpdateRoleStatus(roleId, int8(status))
	if err != nil {
...
func (api *SysRoleApi) GetRoleMenuIds(c *gin.Context) {
	...
	// 调用服务获取角色菜单ID集合
	menuIds, err := api.roleService.GetRoleMenuIds(roleId)
	if err != nil {
...
func (api *SysRoleApi) AssignMenusToRole(c *gin.Context) {
	...
	// 调用服务分配菜单给角色
	err = api.roleService.AssignMenusToRole(roleId, menuIds)
	if err != nil {
