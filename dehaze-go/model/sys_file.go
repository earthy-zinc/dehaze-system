...
// SysFile 文件表
type SysFile struct {
	ID         int       `gorm:"primaryKey;autoIncrement;column:id;comment:文件id" json:"id"`
	...
	MD5        string    `gorm:"column:md5;type:char(32);not null;uniqueIndex:md5;uniqueIndex:md5_key;comment:文件的MD5值，用于比对文件是否相同" json:"md5"`
	CreatedAt  time.Time `gorm:"column:create_time;type:datetime;not null;comment:创建时间" json:"createTime"`
	UpdatedAt  time.Time `gorm:"column:update_time;type:datetime;comment:更新时间" json:"updateTime"`
}
