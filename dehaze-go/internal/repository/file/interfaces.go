...
type IFileRepository interface {
	...
	// FindPage 分页查询文件列表（keywords 模糊匹配 name 或 type；ownerID 非 nil 时仅返回该用户上传的文件）
	FindPage(ctx context.Context, pageNum, pageSize int, keywords string, ownerID *int64) ([]model.SysFile, int64, error)
