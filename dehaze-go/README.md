...
基于 Go 1.25、Gin、GORM、JWT、Redis 构建的图像去雾系统后端。详细设计文档见 `dehaze-doc/`。
...
基于 Go 1.20、Gin、JWT、Redis、GORM、Swagger 构建的前后端分离图像去雾系统后端。包括用户管理、角色管理、菜单管理、部门管理、字典管理等多个功能。使用
Swagger 自动生成接口文档，支持在线调试，提高开发效率。
