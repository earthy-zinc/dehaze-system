...
func SetupAuthRouter() *gin.Engine {
	...
	userService := userservice.NewUserService(userRepo, roleRepo, deptRepo, menuRepo, nil)
	authService := authservice.NewAuthService(cacheClient, userService, nil, gormDB)
