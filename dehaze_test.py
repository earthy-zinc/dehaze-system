...
if __name__ == '__main__':
    ...
    other_error_count = 0
    clean_img = "D:\DeepLearning\dataset\RESIDE\ITS\hazy//1_1_0.90179.png"
    haze_img = "D:\DeepLearning\dataset\RESIDE\ITS\clear//1.png"
    for module in modules_to_test:
        ...
        for model_path in model_paths:
            try:
                ...
                model.dehaze(clean_img, haze_img, model_path)
