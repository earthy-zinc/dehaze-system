...
import com.pei.workflow.handler.WorkflowPermissionHandler;
import com.pei.workflow.mapper.FlwCategoryMapper;
import com.pei.workflow.mapper.FlwTaskMapper;
...
public class FlwTaskServiceImpl implements IFlwTaskService {
    ...
    public RemoteStartProcessReturn startWorkFlow(StartProcessBo startProcessBo) {
        ...
        // 流程发起人
        variables.put(FlowConstant.INITIATOR, LoginHelper.getUserIdStr());
        // 业务id
