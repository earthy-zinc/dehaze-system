...
values ('3', '系统工具', '0', '4', 'tool', null, '', 1, 0, 'M', '0', '0', '', 'tool', 103, 1, sysdate, null, null,
        '系统工具目录');
insert into sys_menu
values ('4', 'PLUS官网', '0', '5', 'https://gitee.com/earthyzinc/dehaze-java', null, '', 0, 0, 'M', '0', '0', '',
...
values ('111', 'Sentinel控制台', '2', '3', 'http://localhost:8718', '', '', 0, 0, 'C', '0', '0',
        'monitor:sentinel:list', 'sentinel', 103, 1, sysdate, null, null, '流量控制菜单');
insert into sys_menu
...
create
or
replace trigger login_trg after logon
on database
begin
