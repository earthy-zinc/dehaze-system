...
model: echo
tools: list_dir, search_file, search_content, read_file, read_lints, replace_in_file, write_to_file, execute_command, codebase_search, use_skill, web_fetch, web_search, task
agentMode: agentic
enabled: true
enabledAutoRun: true
---
