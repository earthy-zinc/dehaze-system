...
import { HomeOutlined, PhotoOutlined, BulbOutlined, SettingOutlined, AppsOutlined } from '@taroify/icons';
import { tabBarItems, isTabBarPage, getTabBarIndex, type MenuItem } from '@/config/menu';
import './index.less';
