...
import com.pei.dehaze.framework.mq.redis.config.PeiRedisMQConsumerAutoConfiguration;
import com.pei.dehaze.framework.mq.redis.core.RedisMQTemplate;
import com.pei.dehaze.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import com.pei.dehaze.framework.websocket.core.listener.WebSocketMessageListener;
import com.pei.dehaze.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import com.pei.dehaze.framework.websocket.core.security.WebSocketAuthorizeRequestsCustomizer;
import com.pei.dehaze.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import com.pei.dehaze.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import com.pei.dehaze.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import com.pei.dehaze.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import com.pei.dehaze.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import com.pei.dehaze.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import com.pei.dehaze.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import com.pei.dehaze.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import com.pei.dehaze.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import com.pei.dehaze.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import com.pei.dehaze.framework.websocket.core.session.WebSocketSessionManager;
import com.pei.dehaze.framework.websocket.core.session.WebSocketSessionManagerImpl;
...
public class PeiWebSocketAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "pei.websocket", name = "sender-type", havingValue = "local")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "pei.websocket", name = "sender-type", havingValue = "redis")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "pei.websocket", name = "sender-type", havingValue = "rocketmq")
    public class RocketMQWebSocketMessageSenderConfiguration {
        ...
        public RocketMQWebSocketMessageSender rocketMQWebSocketMessageSender(
                ...
                @Value("${pei.websocket.sender-rocketmq.topic}") String topic) {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "pei.websocket", name = "sender-type", havingValue = "rabbitmq")
    public class RabbitMQWebSocketMessageSenderConfiguration {
         ...
         */
        @Bean
        public TopicExchange websocketTopicExchange(@Value("${pei.websocket.sender-rabbitmq.exchange}") String exchange) {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "pei.websocket", name = "sender-type", havingValue = "kafka")
    public class KafkaWebSocketMessageSenderConfiguration {
        ...
        public KafkaWebSocketMessageSender kafkaWebSocketMessageSender(
                ...
                @Value("${pei.websocket.sender-kafka.topic}") String topic) {
