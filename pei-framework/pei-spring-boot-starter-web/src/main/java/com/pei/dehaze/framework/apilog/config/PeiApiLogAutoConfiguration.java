...
import com.pei.dehaze.framework.apilog.core.filter.ApiAccessLogFilter;
...
@AutoConfiguration(after = PeiWebAutoConfiguration.class)
public class PeiApiLogAutoConfiguration implements WebMvcConfigurer {
