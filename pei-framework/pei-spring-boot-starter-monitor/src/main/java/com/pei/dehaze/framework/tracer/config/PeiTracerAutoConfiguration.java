package com.pei.dehaze.framework.tracer.config;

import com.pei.dehaze.framework.common.enums.WebFilterOrderEnum;
import com.pei.dehaze.framework.tracer.core.aop.BizTraceAspect;
import com.pei.dehaze.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "pei.tracer", value = "enable", matchIfMissing = true)
public class PeiTracerAutoConfiguration {
