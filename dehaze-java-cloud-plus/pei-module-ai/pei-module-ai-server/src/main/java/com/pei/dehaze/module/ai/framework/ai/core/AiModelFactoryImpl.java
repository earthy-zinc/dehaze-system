package com.pei.dehaze.module.ai.framework.ai.core;
...
import com.pei.dehaze.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            PeiAiProperties.MidjourneyProperties properties = SpringUtil.getBean(PeiAiProperties.class)
                    .getMidjourney();
