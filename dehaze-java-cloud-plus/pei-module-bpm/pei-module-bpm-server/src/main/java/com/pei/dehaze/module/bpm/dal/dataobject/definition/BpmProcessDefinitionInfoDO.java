...
import com.pei.dehaze.module.bpm.enums.definition.BpmAutoApproveTypeEnum;
...
/**
 * BPM 流程定义的拓信息 主要解决 Flowable {@link org.flowable.engine.repository.ProcessDefinition} 不支持拓展字段，所以新建该表
 *
 * @author earthyzinc
 */
...
public class BpmProcessDefinitionInfoDO extends BaseDO {
     ...
     * 如果为空，则表示“全部可以发起”！
     * <p>
     * 它和 {@link #visible} 的区别在于： 1. {@link #visible} 只是决定是否可见。即使不可见，还是可以发起 2. startUserIds
     * 决定某个用户是否可以发起。如果该用户不可发起，则他也是不可见的
     */
