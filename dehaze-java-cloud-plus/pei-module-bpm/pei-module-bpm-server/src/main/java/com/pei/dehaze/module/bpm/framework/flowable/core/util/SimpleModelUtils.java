package com.pei.dehaze.module.bpm.framework.flowable.core.util;
...
import com.pei.dehaze.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO.ConditionGroups;
...
import com.pei.dehaze.module.bpm.framework.flowable.core.listener.BpmCopyTaskDelegate;
import com.pei.dehaze.module.bpm.framework.flowable.core.listener.BpmTriggerTaskDelegate;
import com.pei.dehaze.module.bpm.service.task.listener.BpmCallActivityListener;
import com.pei.dehaze.module.bpm.service.task.listener.BpmUserTaskListener;
...
import static com.pei.dehaze.module.bpm.framework.flowable.core.enums.BpmnModelConstants.*;
 ...
 * 仿钉钉/飞书的模型相关的工具方法
 * <p>
 * 1. 核心的逻辑实现，可见 {@link #buildBpmnModel(String, String, BpmSimpleModelNodeVO)} 方法 2. 所有的 BpmSimpleModelNodeVO 转换成 BPMN
 * FlowNode 元素，可见 {@link NodeConvert} 实现类
 *
 * @author jason
 */
public class SimpleModelUtils {
     ...
     * <p>
     * 整体逻辑如下： 1. 创建：BpmnModel、Process 对象 2. 转换：将 BpmSimpleModelNodeVO 转换成 BPMN FlowNode 元素 3. 连接：构建并添加节点之间的连线 Sequence
     * Flow
     *
