...
import com.pei.dehaze.module.iot.controller.admin.ota.vo.upgrade.task.IotOtaUpgradeTaskPageReqVO;
import com.pei.dehaze.module.iot.controller.admin.ota.vo.upgrade.task.IotOtaUpgradeTaskSaveReqVO;
...
import com.pei.dehaze.module.iot.dal.mysql.ota.IotOtaUpgradeTaskMapper;
import com.pei.dehaze.module.iot.enums.ota.IotOtaUpgradeTaskScopeEnum;
import com.pei.dehaze.module.iot.enums.ota.IotOtaUpgradeTaskStatusEnum;
...
public class IotOtaUpgradeTaskServiceImpl implements IotOtaUpgradeTaskService {
     ...
     * @throws com.pei.dehaze.framework.common.exception.ServerException 则抛出预定义的异常
     */
     ...
     * @throws com.pei.dehaze.framework.common.exception.ServiceException，抛出相应的异常
     */
