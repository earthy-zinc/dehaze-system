...
import com.pei.dehaze.module.iot.dal.mysql.ota.IotOtaUpgradeRecordMapper;
import com.pei.dehaze.module.iot.enums.ota.IotOtaUpgradeRecordStatusEnum;
...
public class IotOtaUpgradeRecordServiceImpl implements IotOtaUpgradeRecordService {
     ...
     * @throws com.pei.dehaze.framework.common.exception.ServiceException，则抛出异常，异常类型为OTA_UPGRADE_RECORD_NOT_EXISTS。
     */
