package com.pei.dehaze.module.iot.service.ota;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.convert.Convert;
import com.pei.dehaze.framework.common.pojo.PageResult;
import com.pei.dehaze.framework.common.util.object.BeanUtils;
import com.pei.dehaze.module.iot.controller.admin.ota.vo.firmware.IotOtaFirmwareCreateReqVO;
import com.pei.dehaze.module.iot.controller.admin.ota.vo.firmware.IotOtaFirmwarePageReqVO;
import com.pei.dehaze.module.iot.controller.admin.ota.vo.firmware.IotOtaFirmwareUpdateReqVO;
...
import com.pei.dehaze.module.iot.dal.mysql.ota.IotOtaFirmwareMapper;
...
import static com.pei.dehaze.module.iot.enums.ErrorCodeConstants.OTA_FIRMWARE_NOT_EXISTS;
import static com.pei.dehaze.module.iot.enums.ErrorCodeConstants.OTA_FIRMWARE_PRODUCT_VERSION_DUPLICATE;
...
public class IotOtaFirmwareServiceImpl implements IotOtaFirmwareService {
     ...
     * @throws com.pei.dehaze.framework.common.exception.ServiceException，则抛出异常，提示固件信息已存在
     */
