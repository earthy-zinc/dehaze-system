...
import com.pei.dehaze.module.iot.api.device.dto.control.upstream.IotDeviceEmqxAuthReqDTO;
 ...
 * <p>
 * 注意：该处理器需要返回特定格式：{"result": "allow"} 或 {"result": "deny"}， 以符合 EMQX 认证插件的要求，因此不使用 IotStandardResponse 实体类
 *
 * @author haohao
 */
