package com.pei.dehaze.framework.mq.redis.config;
...
import com.pei.dehaze.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import com.pei.dehaze.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import com.pei.dehaze.framework.mq.redis.core.pubsub.AbstractRedisChannelMessageListener;
import com.pei.dehaze.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
...
public class PeiRedisMQConsumerAutoConfiguration {
     ...
     * <p>
     * 基础知识：<a href="https://www.geek-book.com/src/docs/redis/redis/redis.io/commands/xreadgroup.html">Redis Stream 的
     * xreadgroup 命令</a>
     */
