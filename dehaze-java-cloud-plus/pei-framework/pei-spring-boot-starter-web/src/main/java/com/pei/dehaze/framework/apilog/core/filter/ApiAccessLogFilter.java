package com.pei.dehaze.framework.apilog.core.filter;
...
import static com.pei.dehaze.framework.apilog.core.interceptor.ApiAccessLogInterceptor.ATTRIBUTE_HANDLER_METHOD;
...
public class ApiAccessLogFilter extends ApiRequestFilter {
    ...
    private boolean buildApiAccessLog(ApiAccessLogCreateReqDTO accessLog, HttpServletRequest request, LocalDateTime beginTime,
        ...
        if (result != null) {
            ...
            accessLog.setResultCode(GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR.code())
                    .setResultMsg(ExceptionUtil.getRootCauseMessage(ex));
        } else {
            accessLog.setResultCode(GlobalErrorCodeConstants.SUCCESS.code()).setResultMsg("");
        }
        // 设置请求字段
