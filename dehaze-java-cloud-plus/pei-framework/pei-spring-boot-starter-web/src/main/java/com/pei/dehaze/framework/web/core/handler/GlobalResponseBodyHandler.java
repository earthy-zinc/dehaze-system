package com.pei.dehaze.framework.web.core.handler;
 ...
 * <p>
 * 目前，GlobalResponseBodyHandler 的主要作用是，记录 Controller 的返回结果， 方便
 * {@link com.pei.dehaze.framework.apilog.core.filter.ApiAccessLogFilter} 记录访问日志
 */
@ControllerAdvice
