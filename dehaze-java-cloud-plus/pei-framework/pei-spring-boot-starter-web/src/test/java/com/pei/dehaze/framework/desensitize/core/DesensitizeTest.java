...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("earthyzinc");
        ...
        desensitizeDemo.setRegex("你好，我是earthyzinc");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("earthyzinc");
        ...
        assertEquals("earthyzinc", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "earthyzinc", replacer = "*")
