...
import com.pei.dehaze.framework.tenant.core.aop.TenantIgnoreAspect;
import com.pei.dehaze.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.pei.dehaze.framework.tenant.core.job.TenantJobAspect;
import com.pei.dehaze.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import com.pei.dehaze.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import com.pei.dehaze.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.pei.dehaze.framework.tenant.core.redis.TenantRedisCacheManager;
import com.pei.dehaze.framework.tenant.core.security.TenantSecurityWebFilter;
import com.pei.dehaze.framework.tenant.core.service.TenantFrameworkService;
import com.pei.dehaze.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.pei.dehaze.framework.tenant.core.web.TenantContextWebFilter;
...
public class PeiTenantAutoConfiguration {
    ...
    public TenantFrameworkService tenantFrameworkService(TenantCommonApi tenantApi) {
        // 参见 https://gitee.com/zhijiantianya/pei-cloud/issues/IC6YZF
        try {
