package com.pei.dehaze.module.system.service.social;
...
import com.pei.dehaze.framework.common.util.cache.CacheUtils;
import com.pei.dehaze.framework.common.util.http.HttpUtils;
import com.pei.dehaze.framework.common.util.object.BeanUtils;
import com.pei.dehaze.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.pei.dehaze.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.pei.dehaze.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.pei.dehaze.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.pei.dehaze.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.pei.dehaze.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.pei.dehaze.module.system.dal.dataobject.social.SocialClientDO;
import com.pei.dehaze.module.system.dal.mysql.social.SocialClientMapper;
...
import com.pei.dehaze.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.pei.dehaze.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 缓存 WxMpService 对象
     * <p>
     * key：使用微信公众号的 appId + secret 拼接，即 {@link SocialClientDO} 的 clientId 和 clientSecret 属性。 为什么 key 使用这种格式？因为
     * {@link SocialClientDO} 在管理后台可以变更，通过这个 key 存储它的单例。
     * <p>
     ...
     * 小程序码要打开的小程序版本
     * <p>
     * 1. release：正式版 2. trial：体验版 3. developer：开发版
     */
    @Value("${pei.wxa-code.env-version:release}")
     ...
     * 订阅消息跳转小程序类型
     * <p>
     * 1. developer：开发版 2. trial：体验版 3. formal：正式版
     */
    @Value("${pei.wxa-subscribe-message.miniprogram-state:formal}")
