package com.pei.dehaze.module.system.dal.redis;
...
public interface RedisKeyConstants {
     ...
     * 用户拥有的角色编号的缓存
     * <p>
     * KEY 格式：user_role_ids:{userId} VALUE 数据类型：String 角色编号集合
     */
     ...
     * 拥有指定菜单的角色编号的缓存
     * <p>
     * KEY 格式：user_role_ids:{menuId} VALUE 数据类型：String 角色编号集合
     */
