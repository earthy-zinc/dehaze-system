package com.pei.dehaze.module.system.service.user;
...
import com.pei.dehaze.module.infra.api.config.ConfigApi;
import com.pei.dehaze.module.infra.api.file.FileApi;
import com.pei.dehaze.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.pei.dehaze.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.pei.dehaze.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.pei.dehaze.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.pei.dehaze.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.pei.dehaze.module.system.controller.admin.user.vo.user.UserSaveReqVO;
...
import com.pei.dehaze.module.system.dal.mysql.dept.UserPostMapper;
import com.pei.dehaze.module.system.dal.mysql.user.AdminUserMapper;
...
import static com.pei.dehaze.framework.test.core.util.AssertUtils.assertServiceException;
...
import static com.pei.dehaze.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn(success("example"));
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("example");
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("example"))).thenReturn("java");
