package com.pei.dehaze.module.member.api.address.dto;
...
public class MemberAddressRespDTO {
    ...
    @Schema(description = "收件详细地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "earthyzinc 88 小区 106 号")
