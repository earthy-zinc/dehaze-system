package com.pei.dehaze.module.mp.service.account;
...
import com.pei.dehaze.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
...
import com.pei.dehaze.module.mp.convert.account.MpAccountConvert;
...
import static com.pei.dehaze.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 pei-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
