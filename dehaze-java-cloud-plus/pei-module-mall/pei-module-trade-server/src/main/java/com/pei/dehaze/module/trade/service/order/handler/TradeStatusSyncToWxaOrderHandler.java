package com.pei.dehaze.module.trade.service.order.handler;
 ...
 * <p>
 * 背景：电商类目的微信小程序需要上传发货信息，不然微信支付会被封 = =！ 注意：微信小程序开发环境下的订单不能用来发货。只有小程序正式版才会有发货，所以体验版无法调通，提示订单不存在。注意别踩坑。
 */
@Slf4j
@Component
@ConditionalOnProperty(prefix = "pei.trade.order", value = "status-sync-to-wxa-enable")
