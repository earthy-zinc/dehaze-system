...
public class AfterSaleDO extends BaseDO {
     ...
     * 申请原因
     * <p>
     * type = 退款，对应 trade_after_sale_refund_reason 类型 type = 退货退款，对应 trade_after_sale_refund_and_return_reason 类型
     */
     ...
     * 商品 SPU 编号
     * <p>
     * 关联 ProductSpuDO 的 id 字段 冗余 {@link TradeOrderItemDO#getSpuId()}
     */
    private Long spuId;
    /**
     * 商品 SPU 名称
     * <p>
     * 关联 ProductSkuDO 的 name 字段 冗余 {@link TradeOrderItemDO#getSpuName()}
     */
