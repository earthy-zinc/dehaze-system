package com.pei.dehaze.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(com.pei.dehaze.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
    ...
    @Schema(description = "结果提示", example = "earthyzinc，牛逼！")
    @ExcelProperty("结果提示")
