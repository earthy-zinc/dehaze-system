package com.pei.dehaze.module.infra.dal.dataobject.logger;
...
public class ApiErrorLogDO extends BaseDO {
     ...
     * 请求参数
     * <p>
     * query: Query String body: Quest Body
     */
     ...
     * 处理用户编号
     * <p>
     * 关联 com.pei.dehaze.adminserver.modules.system.dal.dataobject.user.SysUserDO.SysUserDO#getId()
     */
