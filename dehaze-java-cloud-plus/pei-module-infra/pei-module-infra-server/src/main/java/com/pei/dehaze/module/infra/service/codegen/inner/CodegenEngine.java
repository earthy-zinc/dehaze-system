package com.pei.dehaze.module.infra.service.codegen.inner;
    ...
    private Map<String, String> getTemplates(Integer frontType) {
        ...
        if (Boolean.FALSE.equals(cloudEnable)) {
            SERVER_TEMPLATES.forEach((templatePath, filePath) -> {
                filePath = StrUtil.replace(filePath, "/pei-module-${table.moduleName}-api", "");
                filePath = StrUtil.replace(filePath, "/pei-module-${table.moduleName}-server", "");
