...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.pei";
    private static final String ARTIFACT_ID = "dehaze-java-cloud-plus";
    private static final String PACKAGE_NAME = "com.pei.dehaze";
    private static final String TITLE = "图像去雾系统";
