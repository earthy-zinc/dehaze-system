package com.pei.dehaze.module.pay.job.order;
...
public class PayOrderSyncJob {
     ...
     * 同步创建时间在 N 分钟之内的订单
     * <p>
     * 为什么同步 10 分钟之内的订单？ 因为一个订单发起支付，到支付成功，大多数在 10 分钟内，需要保证轮询到。 如果设置为 30、60
     * 或者更大时间范围，会导致轮询的订单太多，影响性能。当然，你也可以根据自己的业务情况来处理。
     */
